...
@section('title', 'Sobre o GoConcursos')

@section('content')
{{-- Hero --}}
<section class="bg-gradient-to-br from-[#C0602A] to-[#8B3A15] text-white py-20">
    <div class="max-w-4xl mx-auto px-4 text-center">
        <h1 class="text-4xl font-bold mb-4">Sobre o GoConcursos</h1>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        <div>
            ...
            <p class="text-gray-600 leading-relaxed mb-4">
                O GoConcursos nasceu com o propósito de democratizar o acesso a oportunidades profissionais e académicas em África.
                Centralizamos concursos públicos, empregos, bolsas de estudo, licitações e muito mais numa única plataforma moderna e acessível.
            </p>
...
<section class="max-w-3xl mx-auto px-4 py-16 text-center">
    ...
    <p class="text-gray-600 mb-8">Junte-se a milhares de profissionais que já utilizam o GoConcursos.</p>
