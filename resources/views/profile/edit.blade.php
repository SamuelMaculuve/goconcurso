    ...
    <form method="POST" action="{{ route('profile.update') }}" enctype="multipart/form-data">
        ...
        <div class="bg-white rounded-2xl shadow p-6 mb-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                {{-- Country --}}
                <div>
                    <label for="country" class="block text-sm font-medium text-gray-700 mb-1">Pais</label>
                    <input id="country" type="text" name="country" value="{{ old('country', $user->country ?? '') }}"
                        class="w-full rounded-lg border border-gray-300 px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-[#C0602A] focus:border-transparent transition @error('country') border-red-400 @enderror"
                ...
                <div>
                    ...
                    <input id="city" type="text" name="city" value="{{ old('city', $user->city ?? '') }}"
                        class="w-full rounded-lg border border-gray-300 px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-[#C0602A] focus:border-transparent transition @error('city') border-red-400 @enderror"
