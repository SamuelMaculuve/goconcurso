...
<head>
    ...
    <title>@yield('title', 'Admin') – GoConcursos</title>
    ...
    <aside class="w-64 flex-shrink-0 flex flex-col" style="background-color:#1a1a2e;">
        ...
        <div class="flex items-center gap-2 px-6 py-5 border-b border-white/10">
            <a href="{{ route('home') }}" class="text-xl font-extrabold text-terracota tracking-tight">
                Go<span class="text-sand">Concursos</span>
            </a>
        ...
        <nav class="flex-1 px-4 py-6 space-y-1 overflow-y-auto">
            ...
            @php
                $adminLinks = [
                    ...
                    ['route' => 'admin.contests.index',  'label' => 'Concursos',     'icon' => 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2'],
